...
<form method="post" action="options.php">
    ...
    <table>
        ...
        <tr>
            <th><?php _e('Tenant Name', 'conoha-ojs-sync') ?>:</th>
            <td>
                <input id="conohaojs-tenant-name" name="conohaojs-tenant-name" type="text"
                    size="15" value="<?php echo esc_attr(
                        get_option('conohaojs-tenant-name')
                    ); ?>" class="regular-text code"/>
            </td>
        </tr>
        <tr>
    ...
    <h3><?php _e('Use CDN options', 'conoha-ojs-sync'); ?></h3>
    <table>
        <tr>
            <th><?php _e('CDN domain', 'conoha-ojs-sync'); ?>:</th>
            <td>
                <input id="conohaojs-cdnhostname" name="conohaojs-cdnhostname" type="text"
                    size="15" value="<?php echo esc_attr(
                        get_option('conohaojs-cdnhostname')
                    ); ?>" class="regular-text code"/>
                <p class="description"><?php _e('If using a CDN service, enter the host name (incl. protocol: https://example.com) used by CDN.', 'conoha-ojs-sync'); ?></p>
            </td>
        </tr>
    </table>
...
<form method="post">
    ...
    <?php submit_button(__('Resynchronization', "conoha-ojs-sync"), 'Secondary', 'resync') ?>
</form>
